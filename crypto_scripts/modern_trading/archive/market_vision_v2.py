...
#Закрытие всех поз. Функция которая закрывает все при аномалии
from trail_stop_pre_final import close_everything
...
def main():
    while True:
        ...
        if check_anomaly(df, atr_threshold=79, volume_threshold=1.5):  # Thresholds can be adjusted
            print("ANOMALY")
