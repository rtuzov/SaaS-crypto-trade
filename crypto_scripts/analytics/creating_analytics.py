...
# Конвертируем объект datetime обратно в строку для использования, например, в R
...
# Путь к файлу данных
signals_data_path = '/root/my_test/fully_automated_analytics/FINALbetween_scripts_1_Modified_FINAL_combined_result.csv'
